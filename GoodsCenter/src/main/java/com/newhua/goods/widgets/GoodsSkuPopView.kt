package com.newhua.goods.widgets
...
class GoodsSkuPopView(context: Activity) : PopupWindow(context), View.OnClickListener {
    ...
    init {
        ...
        //设置SelectPicPopup弹出窗体的宽
        this.width = ViewGroup.LayoutParams.MATCH_PARENT
        //设置SelectPicPopup弹出窗体的高
        this.height = ViewGroup.LayoutParams.MATCH_PARENT
        //设置SelectPicPopup弹出窗体可点击
        this.isFocusable = true
        //设置SelectPicPopup弹出窗体动画效果
    ...
    fun getSelectSku(): String {
        ...
        return skuInfo.take(skuInfo.length - 1)//删除最后一个分割
    }

    //获取商品数量
    fun getSelectedCount() = mRootView.mSkuCountBtn.number
